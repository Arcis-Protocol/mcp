...
const ADDR = {
  ...
  strategy: "0x43626D6162Ccb12328B989BB228DaD2941F2F12a" as Address,
...
server.tool(
  {
    ...
    description: "List all deployed Arcis Protocol contract addresses on Base with their roles.",
    schema: z.object({}),
  },
  async () => {
    return object({
